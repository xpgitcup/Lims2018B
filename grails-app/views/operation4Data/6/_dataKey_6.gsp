    ...
    <fieldset class="form">
      <table>
        <f:with bean="dataItem">
          <tr>
            <td>
              <label>测试性数据字典3/(6).数据标签3.1/(模型)</label>
            </td>
            <td>
              <g:hiddenField name="dataKey.id" value="6" />
            </td>
          </tr>
        </f:with>
      </table>
      <table>
        <tr>
          <td>
            <label>key3.1.0 dataKeyNormal</label>
            <g:hiddenField name="subDataItems[0].dataKey.id" value="7" />
