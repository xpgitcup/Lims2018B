        ...
        <fieldset class="form">
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="subDataItems[1].dataValue" id="dataValue_1" value="Mon Nov 19 17:26:22 CST 2018" class="datePicker" />
              </td>
              <td />
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="subDataItems[7].dataValue" id="dataValue_7" value="Mon Nov 19 17:26:22 CST 2018" class="datePicker" />
              </td>
              <td />
            </tr>
          </table>
