    ...
    <fieldset class="form">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="subDataItems[1].dataValue" id="dataValue_1" value="Mon Nov 19 11:22:42 CST 2018" class="datePicker" />
          </td>
          <td />
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <select name="subDataItems[5].dataValue" id="dataValue_5">
              <option value="测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.0">测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.0</option>
              <option value="测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.1">测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.1</option>
              <option value="测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.2">测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.2</option>
              <option value="测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.3">测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.3</option>
              <option value="测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.4">测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.4</option>
              <option value="测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.5">测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.5</option>
              <option value="测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.6">测试性数据字典9/(45).数据标签9.7/(模型)=测试性数据9.7.6</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <input type="text" name="subDataItems[7].dataValue" id="dataValue_7" value="Mon Nov 19 11:22:42 CST 2018" class="datePicker" />
          </td>
          <td />
        </tr>
      </table>
